...
/* Sensor Status */
#define SENSOR_STATUS_DATA_AVAILABLE      (1UL << 0)
#define SENSOR_STATUS_DATA_OVERRUN        (1UL << 1)
...
/**
  \fn          int32_t Sensor_GetStatus (uint32_t type)
  \brief       Retrive sensor status.
  \param[in]   type sensor type
  \return      >=0 Sensor status
               < 0 return code
*/
