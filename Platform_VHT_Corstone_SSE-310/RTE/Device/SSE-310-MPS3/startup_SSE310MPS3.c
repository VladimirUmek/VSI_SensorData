...
extern const pFunc __VECTOR_TABLE[];
  ...
  ARM_VSI2_Handler,                  /*  224: VSI 2 */
  ARM_VSI3_Handler,                  /*  224: VSI 3 */
  ARM_VSI4_Handler,                  /*  224: VSI 4 */
  ARM_VSI5_Handler,                  /*  224: VSI 5 */
  ARM_VSI6_Handler,                  /*  224: VSI 6 */
  ARM_VSI7_Handler,                  /*  224: VSI 7 */
#endif
};
